  ...
  return (
    <div className="pt-20">
      <div className="max-w-[1176px] w-full mx-auto relative">
        ...
        {/* <div className="absolute left-0 sm:left-1/2 sm:-translate-x-1/2 sm:top-20 w-full h-full">
          <div className="relative  sm:w-[250px] md:w-[300px] lg:w-[350px] xl:w-[423px]">
