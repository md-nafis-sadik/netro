...
function Revolution() {
  ...
  return (
    ...
    >
      <div
        className="px-6 w-full max-w-[964px] mx-auto text-center relative z-[99]"
        ref={contentRef}
      >
        <h2
        ...
        <div className="max-w-max mx-auto">
          <Link
            href="/"
            className="w-full revolution-button flex_center gap-3 p-2 pl-4 bg-black text-white text-base leading-[170%] font-semibold rounded-full mt-14 transition-all hover:shadow-[0_0_30px_rgba(239,68,68,0.4)]"
          >
