"use client";
import { handleCopy } from "@/services";
import { useState } from "react";

const JournalDetailsShareSocials = ({ journal }: any) => {
  const baseUrl = process.env.NEXT_PUBLIC_APP_URL;
  const [value, setValue] = useState(null);
  const url = `${baseUrl}/blogs/${journal?.title}`;
...
export default JournalDetailsShareSocials;
