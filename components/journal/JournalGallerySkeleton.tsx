      ...
      <div className="flex flex-col md:flex-row gap-6 lg:gap-10 xl:gap-20">
        <div className="w-full lg:w-3/5 flex flex-col gap-7 md:gap-10">
          {Array(4)
            ...
            .map((_, index) => (
              <div key={index}>
                <Skeleton className="h-[360px] md:h-[416px] w-full min-w-[260px] md:min-w-[400px]" />
                <Skeleton className="h-[42px] md:h-[52px] w-full mt-4 md:mt-6" />
                {/* <Skeleton className="h-[22px] md:h-[28px] w-full mt-2 md:mt-4" /> */}
              </div>
            ))}
        </div>
            ...
            <div className="flex flex-col gap-7 md:gap-10">
              {Array(6)
                ...
                .map((_, index) => (
                  <Skeleton
                    key={index}
                    className="h-[120px] md:h-[130px] w-full mt-4"
                  />
                ))}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              {Array(3)
                ...
                .map((_, index) => (
                  <Skeleton
                    key={index}
                    className="h-[40px] md:h-[50px] w-full mt-4"
                  />
                ))}
            </div>
          </div>
...
export default JournalGallerySkeleton;
