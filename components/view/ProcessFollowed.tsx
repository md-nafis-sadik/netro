...
const icons = {
  research: <GlobeSearch className="process-icon size-8" />,
  architecture: <LightIcon className="process-icon size-8" />,
  design: <PainIcon className="process-icon size-8" />,
  development: <CodeIcon className="process-icon size-8" />,
};
    ...
    >
      <div className="container flex_center flex-col">
        ...
        <div className="w-full relative mt-16">
          <div className="process-grid grid grid-cols-4 gap-8 mb-12">
            {processData.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "process-card p-3 border-b w-full relative cursor-pointer",
                ...
                >
                  ...
                  <div className="flex flex-col mt-6">
                    <h3 className="text-2xl text-black leading-[140%] mb-2">
                      {item.title}
                    </h3>
